REM   Script: Error Message Functions: SQLERRM and DBMS_UTILITY.FORMAT_ERROR_STACK
...
-- The third argument of raise_application_error determines whether or not the stack of errors is kept or discarded. TRUE = Keep.
