REM   Script: Analytic View for SH Schema
REM   This script will create create analytic view objects for the SH (sales history) schema.  This script requires Oracle 12.2.
