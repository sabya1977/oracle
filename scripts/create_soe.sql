...
-- SOETBS  (Tablespace) 
--
CREATE TABLESPACE SOETBS DATAFILE '+DATA'
...
GRANT SELECT ON GV_$PARAMETER to soe;
GRANT SELECT ON GV_$SESSION TO SOE;
GRANT SELECT ON GV_$SQL_PLAN_STATISTICS_ALL TO SOE;
GRANT SELECT ON GV_$SQL TO SOE;
GRANT SELECT ON GV_$SQL_PLAN TO SOE;
GRANT SELECT ON GV_$SQL_SHARED_CURSOR TO SOE;
GRANT SELECT ON GV_$SQL TO SOE;
GRANT SELECT ON GV_$PROCESS TO SOE;
GRANT SELECT ON GV_$MYSTAT TO SOE;
GRANT SELECT ON GV_$SQL TO SOE;
GRANT SELECT ON GV_$SQL_BIND_CAPTURE TO SOE;
GRANT SELECT ON GV_$SQLAREA TO SOE;
GRANT SELECT ON GV_$SQLAREA_PLAN_HASH TO SOE;
GRANT SELECT ON GV_$SQLSTATS TO SOE;
GRANT SELECT ON GV_$RESULT_CACHE_OBJECTS TO SOE;
...
GRANT SELECT ON SYS.GV_$PARAMETER TO SOE;
